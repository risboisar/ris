    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#111827] to-[#1e1b4b] text-white flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-3 py-5 space-y-5">
        {messages.map((msg) => (
          ...
          >
            <div
              className={`w-11 h-11 rounded-full flex items-center justify-center font-bold shrink-0 shadow-lg ${
                msg.is_admin
                  ? 'bg-gradient-to-br from-yellow-400 via-orange-500 to-red-500 text-black'
            ...
            <div className="max-w-[82%]">
              ...
              <div
                className={`backdrop-blur-xl border rounded-3xl px-4 py-3 shadow-xl ${
                  msg.is_admin
              ...
              >
                ...
                <div className="flex items-center gap-2 mb-1 flex-wrap">
                  ...
                  {msg.is_admin && (
                    <span className="bg-black text-yellow-400 text-[10px] px-2 py-1 rounded-full font-bold tracking-wide">
                      ADMIN
                    </span>
                  )}
                </div>
